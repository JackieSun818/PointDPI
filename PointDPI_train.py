...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', type=str, default='_confi_greater_than_50', help='file name')
    ...
    with open('dataset/' + task + '/result/train' + path + '.csv') as f1:
    ...
    for epoch in range(EPOCH):
        ...
        with open('dataset/' + task + '/result/test' + path + '.csv') as f1:
    ...
    torch.save(best_model.state_dict(), 'models/best_Matching_' + task + '_' + path + '_' + str(max_auc) + '_seed' + str(SEED) + '.pth')
